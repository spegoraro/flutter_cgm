...
class CircularArc3Point extends Command {
  ...
  late final Point<double> point1;
  late final Point<double> point2;
  late final Point<double> point3;
  ...
  Point<double> _findCenter(double x1, double y1, double x2, double y2, double x3, double y3) {
    return Point<double>(
        ((((x1 * x1) * (y3 - y2)) +
